...
void FixedSizeStack_push(FixedSizeStack *stack, unsigned data, error_t *error); // положить элемент на верхушку стека
unsigned FixedSizeStack_pop(FixedSizeStack *stack, error_t *error); // взять последний положенный элемент со стека
unsigned FixedSizeStack_peek(FixedSizeStack *stack, error_t *error); // посмотерть верхний элемент стека
